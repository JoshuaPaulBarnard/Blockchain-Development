...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x7b54;
...
const uint64_t MONEY_SUPPLY                                  = 3000000000000;
...
//TODO Define minimum fee for transactions (actual fee is MINIMUM_FEE / CRYPTONOTE_DISPLAY_DECIMAL_POINT)
...
const char     CRYPTONOTE_NAME[]                             = "redwoodcoin";
